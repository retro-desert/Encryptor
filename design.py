...
class Ui_Encryptor(object):
    def setupUi(self, Encryptor):
        ...
        Encryptor.setFont(font)
        self.centralwidget = QtWidgets.QWidget(Encryptor)
        self.centralwidget.setObjectName("centralwidget")
        self.btnBrowseFiles = QtWidgets.QPushButton(self.centralwidget)
        self.btnBrowseFiles.setGeometry(QtCore.QRect(380, 10, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.btnBrowseFiles.setFont(font)
        ...
        self.listWidget.setGeometry(QtCore.QRect(380, 60, 161, 101))
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(10, 40, 251, 31))
        font = QtGui.QFont()
        font.setUnderline(False)
        self.pushButton_9.setFont(font)
        self.pushButton_9.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_9.setObjectName("pushButton_9")
        self.btnBrowseFolder = QtWidgets.QPushButton(self.centralwidget)
        self.btnBrowseFolder.setGeometry(QtCore.QRect(460, 10, 81, 41))
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(False)
        font.setUnderline(False)
        font.setWeight(50)
        font.setKerning(True)
        self.btnBrowseFolder.setFont(font)
        self.btnBrowseFolder.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, Encryptor):
        ...
        Encryptor.setWindowTitle(_translate("Encryptor", "Encryptor 1.990 FINAL"))
        self.btnBrowseFiles.setText(_translate("Encryptor", "CHOOSE\n"
"FILES"))
        ...
        self.btnBrowseFolder.setText(_translate("Encryptor", "CHOOSE\n"
"FOLDER"))
