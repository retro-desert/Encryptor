...
class Ui_Encryptor(object):
    def setupUi(self, Encryptor):
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(10, 330, 111, 31))
        self.pushButton_6.setObjectName("pushButton_6")
        self.text_edit = QtWidgets.QTextEdit(self.centralwidget)
        self.text_edit.setGeometry(QtCore.QRect(150, 210, 341, 161))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(10, 250, 111, 31))
        self.pushButton_7.setObjectName("pushButton_7")
        self.pushButton_8 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_8.setGeometry(QtCore.QRect(10, 290, 111, 31))
    ...
    def retranslateUi(self, Encryptor):
        ...
        Encryptor.setWindowTitle(_translate("Encryptor", "Encryptor 1.6"))
